		...
		<!-- Nav -->
			...
			<section id="banner" class="style3" data-video="images/banner" style="background-image:url(images/backgroundlight.jpg);">
				<div class="inner"><p style="text-align:right;font-size:12pt;padding:0;margin-right:12%;font: inherit;margin-top:11%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
					<div class="box_login content">
						...
						<h3>Kërko perdoruesit që gjenden në uebaplikacion për fshirje</h3>		<hr>
						

							<form method="post" action="#">
										<div class="row uniform">
											<div class="9u 12u$(small)">
												<input type="text" name="query" id="query" placeholder="Kërko përdoruesit me të drejta të administratorit" />
											</div>
			...
			<div class="table-wrapper" style="text-align:justify;text-justify:interword;">
										<table style="color:black">
												...
												<tr>
													<td style="color:black">Emri i përdoruesit</td>
													<td style="color:black">Fjalëkalimi</td>
													<td style="color:black;text-align:center">Imella</td>
...
$sql = mysqli_query($lidhu_perdorues,"CALL zgjedhQueryPerdorues('$query')"); 
while($rreshti = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$rreshti['Perdoruesi']."</td>";
		echo "<td>".$rreshti['Fjalekalimi']."</td>";
		echo "<td style=\"text-align:center;\">".$rreshti['Imella']."</td>";
	
			
	
		
		echo "<td><a href=\"fshij_perdorues.php?ID_Perdoruesi=$rreshti[ID_Perdoruesi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini perdoruesin?')\"  class='button special alt' class='button fit'>
		Fshijë</a></td></tr>";		
	}
