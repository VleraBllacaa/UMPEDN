		...
		<!-- Nav -->
			...
			<section id="banner" class="style3" data-video="images/banner" style="background-image:url(images/backgroundlight.jpg);">
				<div class="inner">	<p style="text-align:right;font-size:12pt;padding:0;margin-right:12%;font: inherit;margin-top:11%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
					<div class="box_login content">
						...
						<h3>Kërko të dhënat e menyve aktuale për modifikim që gjenden në uebaplikacion</h3>		<hr>
						

							<form method="post" action="#">
										<div class="row uniform">
											<div class="9u 12u$(small)">
												<input type="text" name="query" id="query" placeholder="Kerko meny" placeholder="Query" />
											</div>
			...
			<div class="table-wrapper" style="text-align:justify;text-justify:interword;">
										<table style="color:black">
												...
												<tr>
													<td style="color:black;">Emri</td>
													<td style="color:black;width:30%;">Linku</td>
...
$query = mysqli_real_escape_string($lidhu_meny,$_REQUEST['query']);     
$sql = mysqli_query($lidhu_meny,"CALL zgjedhQueryMeny('$query')"); 
while($rreshti = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$rreshti['Emri']."</td>";
		echo "<td>".$rreshti['Linku']."</td>";
		echo "<td>".$rreshti['Moduli']."</td>";	
		
		
		echo "<td><a href=\"modifiko_meny.php?ID_Meny=$rreshti[ID_Meny]\"  class='button special alt' class='button fit'>
		Modifiko</a></td></tr>";		
	}
