			...
			<section id="banner" class="style3" data-video="images/banner" style="background-image:url(images/backgroundlight.jpg);">
				<div class="inner">		<p style="text-align:right;font-size:12pt;padding:0;margin-right:12%;font: inherit;margin-top:11%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
					<div class="box_login content">
						...
						<h3>Kërko porositë që gjenden në uebaplikacion per fshirje</h3>		<hr>
						

							<form method="post" action="#">
										<div class="row uniform">
											<div class="9u 12u$(small)">
												<input type="text" name="query" id="query" placeholder="Kërko porositë e pajisjeve elektroshtëpiake"  />
											</div>
			...
			<div class="table-wrapper" style="text-align:justify;text-justify:interword;">
										<table style="color:black">
												...
												<tr>
													...
													<td style="color:black">Numri i njësisë</td>
														<td style="color:black">Kodi</td>
													<td style="color:black">Lokacioni</td>
													<td style="color:black">Numri i telefonit</td>
													<td style="color:black">Emri i klientit</td>
...
($lidhu_porosi,$_REQUEST['query']);     

$sql = mysqli_query($lidhu_porosi,"CALL zgjedhQueryPorosi('$query')"); 
  
while($rreshti = mysqli_fetch_array($sql)) { 		
	echo "<tr>";
		echo "<td>".$rreshti['Emri_pajisjes']."</td>";
		echo "<td>".$rreshti['Sasia']."</td>";
		echo "<td>".$rreshti['Kodi_pajisjes']."</td>";
		echo "<td>".$rreshti['Adresa']."</td>";
		echo "<td>".$rreshti['Nr_tel']."</td>";	
		echo "<td>".$rreshti['Emri_klientit']."</td>";	
		
			
		
		echo "<td><a href=\"fshij_porosi.php?ID_Porosia=$rreshti[ID_Porosia]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini porosine?')\"  class='button special alt' class='button fit'>
		Fshijë</a></td></tr>";		
	}
