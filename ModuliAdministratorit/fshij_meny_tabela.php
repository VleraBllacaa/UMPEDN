		...
		<!-- Nav -->
			...
			<section id="banner" class="style3" data-video="images/banner" style="background-image:url(images/backgroundlight.jpg);">
				<div class="inner">		<p style="text-align:right;font-size:12pt;padding:0;margin-right:12%;font: inherit;margin-top:11%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
					<div class="box_login content">
						...
						<h3>Kërko të dhënat e menyve që gjenden në uebaplikacion për fshirje</h3>		<hr>
						

							<form method="post" action="#">
										<div class="row uniform">
											<div class="9u 12u$(small)">
												<input type="text" name="query" id="query" placeholder="Kërko menytë për fshirje" />
											</div>
			...
			<div class="table-wrapper" style="text-align:justify;text-justify:interword;">
										<table style="color:black">
												...
												<tr>
													<td style="color:black;30%">Emri</td>
													<td style="color:black;width:35%">Linku</td>
													<td style="color:black;">Moduli</td>
...
($lidhu_meny,$_REQUEST['query']);     
$sql = mysqli_query($lidhu_meny,
"CALL zgjedhQueryMeny('$query')

 "); 
while($rezultait = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$rezultait['Emri']."</td>";
		echo "<td>".$rezultait['Linku']."</td>";
		echo "<td>".$rezultait['Moduli']."</td>";	
		
	
		echo "<td><a href=\"fshij_meny.php?ID_Meny=$rezultait[ID_Meny]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini menyne?')\"  class='button special alt' class='button fit'>
		Fshijë</a></td></tr>";		
	}
