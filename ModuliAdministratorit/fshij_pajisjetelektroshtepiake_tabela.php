			...
			<section id="banner" class="style3" data-video="images/banner" style="background-image:url(images/backgroundlight.jpg);">
				...
				<p style="text-align:right;font-size:12pt;padding:0;margin-right:12%;font: inherit;margin-top:11%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
					<div class="box_login content">
						<h3>Kërko pajisjet elektroshtëpiake që gjenden në uebaplikacion per fshirje</h3>		
							<hr>
							<form method="post" action="#">
								...
								<div class="3u$ 12u$(small)">
									<input type="submit" value="Kërko" class="fit" style="background-color:black;color:white !important;"/>											</div>
								</div>
							</form>	
			<br><br><br>
									...
									<div class="table-wrapper" style="text-align:justify;text-justify:interword;">
										<table style="color:black">
												...
												<tr>
													...
													<td style="color:black">Brendi</td>
												...
												($lidhu_pajisje,$_REQUEST['query']);     
												$sql = mysqli_query($lidhu_pajisje,
												"CALL zgjedhQueryPajisje('$query') "); 
												while($rreshti = mysqli_fetch_array($sql)) { 		
														...
														echo "<td><img style='vertical-align: text-top;'src=data:Foto/jpeg;base64,".base64_encode($rreshti['Foto'])." width='100'  height='100'/></td>";
														echo "<td>".$rreshti['Emri_Brendit']."</td>";	
														echo "<td><a href=\"fshij_pajisjetelektroshtepiake.php?ID_pajisjaElektroshtepiake=$rreshti[ID_pajisjaElektroshtepiake]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini pajisjen?')\"  class='button special alt' class='button fit'>
														Fshijë</a></td></tr>";		
													}
												}
												?>						
