...
/* Faqja (home.php) e cila paraqitet pasi perdoruesi te llogohet me sukses */
	include("kontrollo.php");		include("konfigurimi.php");
		...
		<!-- Nav -->
			<nav id="menu">
				...
				<p style="text-align:right;font-size:12pt;padding:0;margin-right:-50%;font: inherit;margin-top:15%;">Përshëndetje, <em><?php  echo $perdoruesi;?>!</em></p>
						...
						<h3>SHTO PËRDORUES ME TË DREJTA TË ADMINISTRATORIT</h3>		<hr>
						

						<form action="shto_perdorues.php" method="post" enctype="multipart/form-data">
								<div class="field half ">
									<input name="Perdoruesi" id="Perdoruesi" type="text" placeholder="Përdoruesi"  >
								</div>
								<br>
								<div class="field half align-center">	
									<input name="Fjalekalimi" id="Fjalekalimi" type="text" placeholder="Fjalëkalimi">
								</div>
								<br>
								<div class="field half align-center">	
									<input name="Imella" id="Imella" type="text" placeholder="Imella">
								</div>
								<ul class="actions align-center">
									<li><input value="SHTO" name="shtoPerdorues" class="button special" type="submit"></li>
								</ul>
							</form>
